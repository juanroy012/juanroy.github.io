...
export default function Hero({ personal }) {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen px-6 pt-24 pb-16 max-w-6xl mx-auto"
    >
      <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-10 items-center min-h-[calc(100vh-8rem)]">
        <div className="flex flex-col justify-center">
          ...
          <motion.div
            ...
            className="font-mono text-lg md:text-xl text-gray-400 mb-8 h-8"
          >
            <TypeAnimation
              sequence={[
        ...
        <motion.div
          ...
          className="min-h-[350px] h-[380px] md:h-[500px]"
          aria-label="Animated characters preview"
        >
          <SplineSceneBasic />
        </motion.div>
      </div>
